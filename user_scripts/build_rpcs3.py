...
def validate_rpcs3_directory(rpcs3_directory):
    ...
    npub30749_folder_path = os.path.join(game_folder_path, "NPUB30749")
    ...
    if not os.path.exists(npub30749_folder_path):
        print("Rock Band Blitz (NPUB30749) not detected in the provided rpcs3 directory. Creating One.")
        os.makedirs(npub30749_folder_path, exist_ok=True)
        return True
...
if successful_extraction:
    if build_patch_ark(False, rpcs3_directory, rpcs3_mode=True):
        ...
        # Copy files from _build/ps3 to rpcs3_directory/game/NPUB30749
        ...
        destination_dir = os.path.join(rpcs3_directory, "game", "NPUB30749")
        ...
        # json_path = os.path.join(rpcs3_directory, "game", "NPUB30749", "USRDIR", "discordrp.json")
        ...
        eboot_bin_path = os.path.join(rpcs3_directory, "game", "NPUB30749", "USRDIR", "eboot.bin")
